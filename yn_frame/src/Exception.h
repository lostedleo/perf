...
class CInvalidInputException : public CException
{
public:
        CInvalidInputException(const char* sErrorMsg, const char* sFile = NULL, int iLine = CException::EMPTY_LINE)
                        : CException(sErrorMsg, sFile, iLine) {}
        virtual ~CInvalidInputException() {}
        friend ostream& operator << (ostream& os, CInvalidInputException& e);
};

class CUnsupportedException : public CException
{
public:
        CUnsupportedException(const char* sErrorMsg, const char* sFile = NULL, int iLine = CException::EMPTY_LINE)
                        : CException(sErrorMsg, sFile, iLine) {}
        virtual ~CUnsupportedException() {}
        friend ostream& operator << (ostream& os, CUnsupportedException& e);
};

class CEmptyException : public CException
{
public:
        CEmptyException(const char* sErrorMsg, const char* sFile = NULL, int iLine = CException::EMPTY_LINE)
                        : CException(sErrorMsg, sFile, iLine) {}
        virtual ~CEmptyException() {}
        friend ostream& operator << (ostream& os, CEmptyException& e);
};
}
#endif
